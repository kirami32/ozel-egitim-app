...
export default async function MudurHedeflerPage() {
  ...
  return (
    <div className="space-y-8">
      <SayfaBasligi
        ...
        aciklama="Kurum genelinde bireyselleştirilmiş eğitim hedeflerinin toplu görünümü."
      />
          ...
          {hedefler.length === 0 ? (
            <div className="p-6">
              <EmptyState
                ...
                aciklama="Öğretmenler öğrenciler için BEP hedefi tanımladıkça burada listelenecek."
              />
            </div>
          ) : (
            <Table>
                ...
                {hedefler.map((hedef) => {
                  ...
                  return (
                    <TableRow key={hedef.id}>
                      ...
                      <TableCell>
                        <Link
                          href={`/mudur/ogrenci/${hedef.student.id}`}
