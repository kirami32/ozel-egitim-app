...
function goreliZaman(tarih: Date) {
                ...
                >
                  ...
                  {silebilir && (
                    <button
                      ...
                      disabled={isPending}
                      aria-label="Notu sil"
                      className="absolute top-2 right-2 rounded-lg p-1 text-muted-foreground opacity-0 transition-opacity hover:bg-destructive/10 hover:text-destructive group-hover:opacity-100"
                    >
